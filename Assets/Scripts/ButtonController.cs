...
public class ButtonController : MonoBehaviour
{
    ...
    //bool to check if the test function is running
    bool testing = false;
   ...
   static string[] websites1 =
    ...
    //other variables for the other variations 
    
    List<string[]> allWebsites = new List<string[]> { websites1, websites2, websites3 };

    string[] CurrentlyTestedWebs;
    
  //function that returns the state of a website given a result
    ...
    public void CheckWebsiteResponse(string website, UnityWebRequest request, TimeSpan time)
    {
        if (request.isDone)
        {
            ...
            {
                Debug.Log("Website " + website + " is inactive. Response code :" + request.responseCode + ", Response time : " + time.TotalMilliseconds + "ms");
            }
            else
            {
                Debug.Log("Website " + website + " is active. Response code :" + request.responseCode + ", Response time : " + time.TotalMilliseconds + "ms");
            }
    ...
    //main function that checks the responsiveness of a website
    ...
    //function called when "démarer" is clicked
    ...
    //function that calls the main testing function
    async void func()
    {
        if (isEchecClicked)
        {
    ...
    //function called when "Echéc" is clicked
    void echec ()
    {
        isEchecClicked = true;
    ...
    //function called when "Arreter" is clicked
    void stop ()
     {
        isStartClicked = false;
    ...
    private void Update()
    {
        ...
        if (isEchecClicked && !exceptionThrown)
        {
        ...
        if (isStartClicked && !testing && !isEchecClicked)
        {
            testing = true;
             func();
        }
